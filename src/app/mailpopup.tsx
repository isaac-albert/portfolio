...
export default function MailToggle({
  ...
  return (
    <div className="fixed inset-0 z-30 bg-transparent backdrop-blur-md flex items-center justify-center">
      ...
      ></div>
      <div className="card mt-10 w-screen linkBreakdown:max-w-4/5 sm:w-1/2 md:1/3 lg:w-1/3 z-50 grid rounded-3xl bg-lightdark dark:bg-dark">
        ...
        <div className="text-copy m-auto flex justify-between w-4/5 mt-8 mb-10 rounded-2xl">
          <div className="basis-5/6 outline-2 lg:outline-4 outline-darksectext dark:outline-lightsectext rounded-l-2xl pt-2 pb-2 whitespace-nowrap overflow-hidden">
          ...
          <button
            ...
            className="basis-1/6 pt-2 pb-2 outline-2 lg:outline-4 dark:bg-darklight dark:hover:bg-dark bg-lightlight hover:bg-light  outline-darksectext dark:outline-lightsectext rounded-r-2xl transition-colors duration-500"
          >
        ...
        <div className="send-mail m-auto mb-10">
          <Button
            variant={"secondary"}
            className="text-lightsectext dark:text-darksectext hover:text-darksectext dark:hover:text-lightsectext bg-lightlight dark:bg-darklight hover:bg-darklight dark:hover:bg-lightlight transition-colors duration-300"
          >
            <Link
